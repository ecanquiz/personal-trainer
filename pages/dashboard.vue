...
<div>
  <div class="">
    ...
    <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
      ...
      <div class="text-gray-500 grid grid-cols-2 md:grid-cols-4 gap-0 bg-slate-100 w-auto mx-auto rounded-3xl">
        <div class="p-4 hover:bg-white border-1 border-slate-200">Vite</div>
        <div class="p-4 hover:bg-white border-1 border-slate-200">VueRouter</div>
        <div class="p-4 hover:bg-white border-1 border-slate-200">Pinia</div>
        <div class="p-4 hover:bg-white border-1 border-slate-200">TypeScript</div>
        <div class="p-4 hover:bg-white border-1 border-slate-200">Tailwind</div>
        <div class="p-4 hover:bg-white border-1 border-slate-200">Vites</div>
        <div class="p-4 hover:bg-white border-1 border-slate-200">VueTestsUtils</div>
        <div class="p-4 hover:bg-white border-1 border-slate-200">VueTestingLibrary</div>    
      </div>
